...
<body>
    ...
    <script src="../../Projeto_GerenciamentoMapaSalas/assets/js/jquery-3.6.0.min.js" type="text/javascript"></script>
    <script src="../../Projeto_GerenciamentoMapaSalas/assets/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="../../Projeto_GerenciamentoMapaSalas/assets/js/sweetalert2.all.min.js" type="text/javascript"></script>
